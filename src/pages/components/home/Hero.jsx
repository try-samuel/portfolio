...
const Hero = () => {
  return (
    <div className="flex flex-wrap xs:mt-48 md:mt-44 lg:mt-80 mb-8">
      ...
      <div className="sm:w-auto md:w-[450px] lg:w-[790px] sm:text-2xl md:text-3xl lg:text-5xl font-semi-bold">
        ...
        <p className="mt-1">
          A<span className="text-green-600"> full stack web developer</span>,
          open to onsite & remote opportunities.
        </p>
      </div>
      <hr className="w-full mt-10 mb-10" />
    </div>
  );
};
